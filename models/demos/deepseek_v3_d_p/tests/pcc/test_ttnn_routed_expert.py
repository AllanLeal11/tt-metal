...
@pytest.mark.parametrize(
    "seq_len_per_chip, emb_dim, hidden_dim, num_routed_experts, num_experts_per_tok, run_pcc_check",
    [
        # fmt: off
        (320, 1024, 512, 64, 2, True),
        (3200, DeepSeekV3Config.EMB_SIZE, DeepSeekV3Config.MOE_INTERMEDIATE_SIZE, 64, 2, False),
        # fmt: on
    ],
