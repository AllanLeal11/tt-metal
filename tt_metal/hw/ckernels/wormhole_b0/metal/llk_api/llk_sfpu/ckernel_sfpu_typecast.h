...
#pragma GCC unroll 8
    for (int d = 0; d < ITERATIONS; ++d) {
        TT_SFPLOAD(p_sfpu::LREG0, InstrModLoadStore::DEFAULT, ADDR_MOD_3, dst_index_in * SFP_DST_TILE_ROWS_64);
        ...
        TT_SFPSTORE(p_sfpu::LREG1, InstrModLoadStore::INT32, ADDR_MOD_2, dst_index_out * SFP_DST_TILE_ROWS_64);
    }
}
...
#pragma GCC unroll 8
    for (int d = 0; d < ITERATIONS; ++d) {
        if constexpr (u16) {
            TT_SFPLOAD(p_sfpu::LREG0, InstrModLoadStore::LO16, ADDR_MOD_3, dst_index_in * SFP_DST_TILE_ROWS_64);
        } else {
            TT_SFPLOAD(p_sfpu::LREG0, InstrModLoadStore::INT32, ADDR_MOD_3, dst_index_in * SFP_DST_TILE_ROWS_64);
        }
        ...
        TT_SFPSTORE(p_sfpu::LREG0, InstrModLoadStore::INT32, ADDR_MOD_2, dst_index_out * SFP_DST_TILE_ROWS_64);
    }
}
